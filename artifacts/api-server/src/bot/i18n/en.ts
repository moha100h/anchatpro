export const en = {
  ...
  queueTimeoutFemale: "😔 All female users are currently in chats.\n\nPlease try again in a few minutes.",
  queueTimeoutMale: "😔 All male users are currently in chats.\n\nPlease try again in a few minutes.",
  queueTimeoutAny: "⏱️ No one is available right now.\n\nPlease try again in a few minutes.",
  ...
  groupLeft: "✅ Left the group. You can rejoin anytime.",
  groupEnded: "🔴 Group has been dissolved.",
  groupDeleteConfirm: "⚠️ **Are you sure?**\n\nThis will permanently delete the group and remove all members immediately. This cannot be undone.",
  groupDeletedByCreator: "✅ Group has been successfully deleted and dissolved.",
  groupDissolved: "⛔️ This group was deleted and dissolved by its creator.\n\nAll members have been removed.",
