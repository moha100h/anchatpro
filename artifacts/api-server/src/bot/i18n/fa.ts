export const fa = {
  ...
  referralBanner: (link: string, inviterReward: number, inviteeReward: number, botUsername: string) =>
    ...
    `🍾 پیام در بطری بفرست به دنیای اسرار\n` +
  ...
  magicMenu: (cfg: { bottleCost: number; chainCost: number; letterCost: number; freqCost: number }) =>
    ...
    `پیامت را به دنیای اسرار رها کن. شاید کسی پیدایش کند...\n\n` +
  ...
  magicConfirmBottle: (cost: number, daily: number) =>
    `🍾 **پیام در بطری**\n\n` +
    `یک پیام ناشناس می‌نویسی و به دنیای اسرار رها می‌کنی.\n` +
  ...
  magicHelpBottle:
    `🍾 **پیام در بطری**\n\n` +
    `یک پیام ناشناس می‌نویسی و به دنیای اسرار می‌فرستی.\n` +
    `سیستم آن را به یک کاربر تصادفی می‌رساند.\n` +
    `اگر آن کاربر جواب داد → چت ناشناس شروع می‌شود.\n` +
    `اگر در ۲۴ ساعت جوابی نداد → پیام در دنیای اسرار گم می‌شود 🌊\n\n` +
  ...
  // ─ Bottle ─
  bottleAskMessage: "🍾 پیامت را برای دنیای اسرار بنویس:\n\n(حداکثر ۵۰۰ کاراکتر — فقط متن)",
  bottleTooLong: "❌ پیام خیلی طولانی است. حداکثر ۵۰۰ کاراکتر.",
  bottleSent: "🌊 پیامت به دنیای اسرار فرستاده شد!\n\nشاید کسی پیدایش کند...",
  bottleReceived: (msg: string) =>
    `🍾 **یک پیام از دنیای اسرار برایت آمد!**\n\n_«${msg}»_\n\nمی‌خواهی پاسخ دهی؟`,
  bottleReplyBtn: "💬 پاسخ دادن",
  bottleIgnoreBtn: "🌊 رها کردن",
  bottleIgnored: "🌊 پیام را رها کردی. باشه!",
  bottleExpiredSender: "🌊 پیامت در دنیای اسرار گم شد. کسی پیدایش نکرد.",
  bottleReplied: "✅ پاسخت فرستاده شد! چت ناشناس شروع شد.",
  bottleNoFloating: "🌊 الان هیچ پیامی در دنیای اسرار نیست. بعداً دوباره امتحان کن.",
