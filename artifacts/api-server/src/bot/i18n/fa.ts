export const fa = {
  ...
  referralStats: (total: number, successful: number, pending: number, coins: number, inviterReward: number, inviteeReward: number) =>
    ...
    `━━━━━━━━━━━━━━━━━━━━━\n` +
    `💰 سکه‌های کسب‌شده از دعوت: **${coins} سکه**\n\n` +
    `🎁 **پاداش فعلی هر دعوت موفق** _(تنظیم‌شده توسط ادمین)_:\n` +
    `┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄\n` +
    `🪙 شما (معرِّف): **${inviterReward} سکه** به ازای هر دعوت\n` +
    (inviteeReward > 0
      ? `🎀 دوست شما (تازه‌وارد): **${inviteeReward} سکه خوش‌آمدگویی** هنگام ثبت‌نام\n`
      : "") +
    `┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄\n` +
