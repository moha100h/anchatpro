export const fa = {
  ...
  referralBanner: (link: string, inviterReward: number, inviteeReward: number, botUsername: string) =>
    ...
    `👥 گروه‌های ناشناس بساز\n` +
    `🍾 پیام در بطری بفرست به اقیانوس\n` +
    `🔗 زنجیر احساس با ۱۰ نفر ناشناس\n` +
    `✉️ نامه به آینده‌ات بنویس\n` +
    `📡 بر اساس حالت الان، جفت ناشناس پیدا کن\n\n` +
    `━━━━━━━━━━━━━━━━━━━━━\n` +
    `🎁 <b>از طریق این لینک عضو شو و ${inviteeReward > 0 ? `${inviteeReward} سکه` : ""} ثبت نام${inviterReward > 0 ? ` و ${inviterReward} سکه معرفی` : ""} هدیه بگیر!</b>\n\n` +
