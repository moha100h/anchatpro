export const fa = {
  ...
  helpSectionMagic:
    ...
    `برای راهنمای هر بخش از منو "🔮 دنیای اسرار" → "📖 راهنما" استفاده کنید.`,
  ...
  // ─ Help ─
  magicHelpMenu: "📖 **راهنمای اقیانوس احساس**\n\nیک بخش را انتخاب کنید:",
  magicHelpBottle:
    `🍾 **پیام در بطری**\n\n` +
  ...
  magicHelpMenuTitle: "📖 **راهنمای دنیای اسرار**\n\nیک ویژگی را برای توضیحات انتخاب کنید:",
